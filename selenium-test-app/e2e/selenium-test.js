        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, driver.findElement(selenium_webdriver_1.By.css('#password'))];
                case 5:
                    passwordInput = _a.sent();
                    return [4 /*yield*/, driver.findElement(selenium_webdriver_1.By.css('#loginButton'))];
                case 6:
                    loginButton = _a.sent();
                ...
                case 7:
                    // Enter test credentials
                    _a.sent();
                    return [4 /*yield*/, passwordInput.sendKeys('testpassword')];
                case 8:
                    _a.sent();
